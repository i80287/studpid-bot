...
class ConsoleCog(Cog):
    ...
    async def setup(self, guild_id):
        ...
        base.commit()
        base.execute('CREATE TABLE shop(item_id INTEGER PRIMARY KEY, role_id INTEGER, seller_id INTEGER, price INTEGER, date TEXT)')
        base.commit()
        base.execute('CREATE TABLE server_roles(roles INTEGER PRIMARY KEY)')
        base.commit()
        base.close()
